...
> **Purpose.** Justify the technical decisions you made in Phase 1 for **Aviation — U.S. Flight Delay Network**.
...
In 3–5 sentences, explain why your team picked **Aviation — U.S. Flight Delay Network** over the other 9 scenarios. What about the problem appeals to you, what skills will you build, and what is the practical impact if you solve it well?
...
- [ ] Both pushed to your group repo at `module-2/class_6/lab-scenarios/10_flight_delay_network/` (or your team's submissions folder)
